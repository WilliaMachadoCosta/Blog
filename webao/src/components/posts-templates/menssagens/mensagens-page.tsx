...
const messages = [
    {
        ...
        url: "https://webao.info/mensagem-de-bom-dia-para-whatsapp",
        external: true,
        icon: Sun,
    },
    {
        ...
        url: "https://webao.info/mensagem-de-boa-noite-para-whatsapp",
        external: true,
        icon: Moon,
    },
    {
        ...
        url: "https://webao.info/mensagem-de-aniversario-para-amigo-90-ideias-para-copiar-e-colar",
        external: true,
        icon: Smile,
    },
    {
        ...
        url: "https://webao.info/mensagem-bom-dia-quinta-feira-motivacional",
        external: true,
        icon: Sun,
    },
    {
        ...
        url: "https://webao.info/as-melhores-mensagens-de-bom-dia-quinta-feira-abencoada-por-deus",
        external: true,
        icon: Sun,
    },
    {
        ...
        url: "https://webao.info/sextou-frases-para-whatsapp",
        external: true,
        icon: Smile,
    },
    {
        ...
        url: "https://webao.info/100-frases-para-recado-do-whatsapp-veja-as-melhores",
        external: true,
        icon: MessageCircle,
    },
];
