...
export default function TweetCreatorClient() {
    ...
    const cta = `👉 Saiba mais em webao.info`;
    ...
    return (
        <>
            <Head>
                ...
                />
                <meta property="og:url" content="https://webao.info/ferramentas/post-tweet-card" />
                ...
                <article className="prose prose-neutral max-w-none mb-10">
                    ...
                    <div className="text-sm text-[#111B21]">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                            <li><a href="https://webao.info/mensagem-de-aniversario-para-amigo-90-ideias-para-copiar-e-colar" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Mensagem de aniversário para amigo</a></li>
                            <li><a href="https://webao.info/mensagem-de-deus-para-whatsapp-1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Mensagem de Deus para WhatsApp</a></li>
                            <li><a href="https://webao.info/mensagem-bom-dia-quinta-feira-motivacional" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Mensagem de bom dia - Quinta-feira</a></li>
                            <li><a href="https://webao.info/mensagem-de-boa-noite-para-whatsapp" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Mensagem de boa noite</a></li>
                            <li><a href="https://webao.info/as-melhores-mensagens-de-bom-dia-quinta-feira-abencoada-por-deus" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Bom dia quinta-feira abençoada</a></li>
                            <li><a href="https://webao.info/sextou-frases-para-whatsapp" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Sextou! Frases para WhatsApp</a></li>
                            <li><a href="https://webao.info/100-frases-para-recado-do-whatsapp-veja-as-melhores" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Frases para recado do WhatsApp</a></li>
                        </ul>
                    </div>
                </article>
