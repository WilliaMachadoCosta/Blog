...
const imagens = [
    ...
    'https://res.cloudinary.com/dengftv0a/image/upload/v1752701072/admin.webao.info/wp-content/themes/neve/assets/img/patterns/neve-patterns-12.jpg',
    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:url" content="https://webao.info/mensagem-de-bom-dia-para-whatsapp" />
            ...
            <main className="max-w-5xl mx-auto px-4 py-10">
                ...
                <p className="text-lg text-gray-700 mb-8 leading-relaxed text-center">
                    Comece o dia com o pé direito e espalhe positividade! Aqui no <strong className="font-semibold">webao.info</strong>, você encontra as mais lindas e inspiradoras <strong>mensagens de bom dia para WhatsApp</strong>, perfeitas para motivar amigos, familiares e colegas. Copie, baixe e compartilhe!
                </p>
                    ...
                    {mensagens.map((mensagem, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-xs mt-4 opacity-80 border-t border-white pt-2">conheça webao.info</p>
                            </div>
    ...
    return (
        <>
            ...
            <section>
                ...
                <p className="text-gray-600 text-justify">
                    Navegue, escolha suas favoritas e transforme a manhã de alguém com webao.info.
                </p>
            </section>
        </>
    );
