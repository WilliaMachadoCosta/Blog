...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const canonicalUrl = `https://webao.info/${post.slug}`;
  const imageUrl = post.featuredImage || "https://webao.info/logo.png";
  ...
  return {
    ...
    metadataBase: new URL("https://webao.info"),
...
export default async function PostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const image = post.featuredImage || "https://webao.info/logo.png";
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: "Blog",
                item: "https://webao.info/blog",
              },
              {
                "@type": "ListItem",
                position: 2,
                name: cleanTitle,
                item: `https://webao.info/${post.slug}`,
              },
            ],
          }),
        }}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            publisher: {
              ...
              logo: {
                "@type": "ImageObject",
                url: "https://webao.info/logo.png",
              },
            },
            mainEntityOfPage: `https://webao.info/${post.slug}`,
            ...(company?.nome && {
              about: {
                "@type": "Organization",
                name: company.nome,
